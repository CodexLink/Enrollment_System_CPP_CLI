...
void Func_NewStdnt_ERLM (struct New_StudentRecords New_Potential_Student);     // Function for New Student
...
void Func_NewStdnt_ERLM (struct New_StudentRecords New_Potential_Student) {
